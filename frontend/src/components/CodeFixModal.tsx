    ...
    <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 200000 }}>
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-3">
          <div>
            <div className="text-xs mb-2" style={{ color: 'var(--vscode-muted)' }}>Selected code</div>
            <pre className="text-xs p-3 rounded overflow-auto" style={{ maxHeight: '220px', background: 'var(--vscode-bg)', border: '1px solid var(--vscode-panel-border)', color: 'var(--vscode-text)' }}>
              <code>{selectedCode}</code>
            </pre>
          </div>
          <div>
            <div className="text-xs mb-2" style={{ color: 'var(--vscode-muted)' }}>Describe how to change this code</div>
            <textarea
              ref={textareaRef}
              value={instruction}
              ...
              style={{ background: 'var(--vscode-contrast)', border: '1px solid var(--vscode-panel-border)', color: 'var(--vscode-text)', resize: 'vertical' }}
            />
          </div>
