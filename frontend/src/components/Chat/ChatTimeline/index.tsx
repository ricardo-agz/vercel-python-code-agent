...
export const ChatTimeline: React.FC<ChatTimelineProps> = ({ actions, isEmpty, loading, onOpenFile, refreshToken }) => {
          ...
          {actions.map((action, idx) => {
            ...
            switch (action.kind) {
              ...
              case 'tool_started':
                ...
                if ((action as unknown as { toolName?: string }).toolName === 'think') return null;
